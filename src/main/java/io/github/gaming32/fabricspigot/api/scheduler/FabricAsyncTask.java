...
class FabricAsyncTask extends FabricTask {
    private final LinkedList<BukkitWorker> workers = new LinkedList<>();
    private final Map<Integer, FabricTask> runners;

    FabricAsyncTask(final Map<Integer, FabricTask> runners, final Plugin plugin, final Object task, final int id, final long delay) {
